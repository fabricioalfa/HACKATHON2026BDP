import{a as P}from"./chunk-RTBBOHGV.js";import{c as Q,e as E,g as N,k as O,ta as q,ua as g,za as A}from"./chunk-T2Z3OJUX.js";import{$ as p,Cb as z,Ha as b,Ia as C,La as $,M as v,N as h,Na as r,S as T,Ua as i,Xa as k,Xb as B,Ya as I,ab as u,bb as d,cb as x,db as M,eb as w,lb as l,mb as D,nb as F,ob as f,qb as m,rb as y,vb as j,wa as o,wb as S}from"./chunk-D4IMPIUR.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
